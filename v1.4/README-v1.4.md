...
- 保留 v1.3 Room ID 房間制與手機體感控制。

## 使用方式

1. 主畫面：`https://lester47.github.io/nantawfood/`
2. 手機控制器：主畫面複製玩家網址，或使用 `player.html?room=房號`
3. 排行榜：`https://lester47.github.io/nantawfood/leaderboard.html`

## MQTT Topic

- 單房間紅隊：`nantou-food-race/{roomId}/red`
- 單房間綠隊：`nantou-food-race/{roomId}/green`
- 單房間摘要：`nantou-food-race/{roomId}/summary`
